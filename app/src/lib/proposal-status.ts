 ...
 *
 * Важно для формулировок в UI: `owner_set_seqno` — версия ПРАВИЛ целиком, а не только
 * списка владельцев. Его бампает и `change_threshold` (governance.rs), поэтому
 * «набор владельцев изменился» — не всегда правда; см. STALE в proposal-actions.ts.
 */
